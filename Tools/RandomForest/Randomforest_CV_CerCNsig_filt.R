...
forest$finalModel
sink()
saveRDS(forest, "RF_Model_CerCNsig_filt.rds")
...
plot(ROCR.perf.train, main="ROC Curve for Random Forest",col=4,lwd=5, xlab = "1-Specificity", ylab= "Sensitivity", cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
axis(side=1, at=seq(0,1,0.1))
axis(side=2, at=seq(0,1,0.1))
plot(ROCR.perf.test, add= T, main="ROC Curve for Random Forest",col=2,lwd=5)
abline(a=0,b=1,lwd=2,lty=2,col="black")
abline(a=1,b=-1,lwd=2,lty=2,col="grey")
dev.off()
...
sessionInfo() %>% capture.output(file="RF_session_info.txt")
