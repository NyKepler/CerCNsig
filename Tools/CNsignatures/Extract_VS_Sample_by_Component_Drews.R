...
CN_features <- extractCopynumberFeaturesDrews(segment_tables)
...
#VS_components <- readRDS("/home/researcher/CerCNsig/Randomforest_Drews/HGSC_VS_good.Components.rds")
...
#' very strange when cores>1, error appear
